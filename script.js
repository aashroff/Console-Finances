var finances = [
    ...
    // Log and display Decorators
    console.log("Financial Analysis");
    console.log("----------------------------")
    document.write("<h2>Financial Analysis</h2>");
    document.write("<p>----------------------------</p>")
    document.write("<br>");
    document.write("<br>");

    //total months in the dataset is the length of the array
    ...
    for(let i = 0; i < totalMonths; i++){
        ...
        if(finances[i][1] > biggestProfit){

            biggestProfit = finances[i][1];
            biggestProfitMonth = i;

        }

        if(finances[i][1] < biggestLoss){
    ...
    document.write("Greatest Increase in Profits: " + finances[biggestProfitMonth][0] +" $" + biggestProfit);
    document.write("<br>");
    console.log("Greatest Decrese in Profits: " + finances[biggestLossMonth][0] +" $" + biggestLoss);
    document.write("Greatest Decrese in Profits: " + finances[biggestLossMonth][0] +" $" + biggestLoss);